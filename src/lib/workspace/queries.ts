...
/** Same lookup as getWorkspaceForUser but by slug — powers every /w/[slug]/* page. */
 ...
 * CASCADE foreign keys already in place (workspace_member, project,
 * workspace_invitation → workspace) — no manual cleanup query needed.
 */
