...
export function SignalBand() {
  return (
    <section className="relative bg-accent py-14 text-[#08090a] lg:py-16">
      <div className="mx-auto max-w-7xl px-5 lg:px-8">
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-[1fr_auto] lg:items-center lg:gap-16">
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-3 lg:gap-14">
            {STATS.map((s) => (
              <div key={s.unit} className="min-w-[140px]">
                <div className="font-mono-tech text-4xl font-bold leading-none">
                  {s.value}
                </div>
