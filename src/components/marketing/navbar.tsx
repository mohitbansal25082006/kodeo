    ...
    >
      <nav className="mx-auto flex h-16 max-w-7xl items-center justify-between px-5 lg:h-[72px] lg:px-8">
        ...
        <button
          ...
          className="inline-flex h-10 w-10 items-center justify-center rounded-lg border border-border bg-surface text-primary lg:hidden"
      ...
      >
        <div className="flex flex-col gap-1 bg-bg px-5 pb-6 pt-2">
          {NAV_LINKS.map((link) => (
            <a
              key={link.href}
              href={link.href}
