    ...
    <section className="relative overflow-hidden pt-28 pb-16 lg:pt-40 lg:pb-24">
      ...
      <div className="relative mx-auto max-w-7xl px-5 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <h1 className="animate-fade-up animate-delay-1 mt-6 text-[2.75rem] font-bold leading-[1.05] tracking-tight text-primary sm:text-6xl lg:text-[4.25rem]">
            Make the thing.
            <br />
            <span className="text-accent">Ship the idea.</span>
          </h1>

          <p className="animate-fade-up animate-delay-2 mx-auto mt-6 max-w-xl text-balance text-base leading-relaxed text-secondary sm:text-lg">
            KODEO is the focused, collaborative workspace for developers who
            move from first line to final deploy without slowing down.
          </p>

          <div className="animate-fade-up animate-delay-3 mt-9 flex flex-col items-center justify-center gap-3 sm:flex-row">
          ...
          <div className="animate-fade-up animate-delay-4 mt-8 flex items-center justify-center gap-3">
        ...
        {/* Editor mockup */}
        <div className="animate-fade-up animate-delay-5 relative mx-auto mt-14 max-w-5xl lg:mt-20">
